...
export default function PartnerDashboard() {
  ...
  const partnerSlug = 'bond';

  // Hydration-safe: Only run after client has mounted
  useEffect(() => {
    setHydrated(true);
  }, []);
      ...
      <div style={{ maxWidth: 1200, margin: '0 auto' }}>
        <div style={{
          ...
          <h1 style={{ fontSize: 36, fontWeight: 800 }}>
            {config.name} Deliveries Dashboard
          </h1>
          <button
...
// Card component with true React hover effect (hydration-safe)
